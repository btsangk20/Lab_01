       ...
       <div>
         <div className="login-imgs">
           <div className="container-image">
              <img src={profile} alt="profile" className="login-profile-image"/>
           </div>
         </div>
        <div>
           <h1>Login</h1>
           <div>
              ...
              <input type="text" placeholder="Enter email" className="login_email-input"/>
           </div>
           <div className="second-input">
              <img src={pass} alt="pass" className="login_password-image"/>
              <input type="password" placeholder="Enter password" className="login_password-input"/>
           </div>
